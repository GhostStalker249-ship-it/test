...
- Настраиваемый дашборд с виджетами:
  ...
  - специальные виджеты Кибер Бекап для задач и действий,
...
- Меню «Настройки Кибер Бекап» для фильтрации статусов задач/действий и лимита строк в специальных виджетах.
